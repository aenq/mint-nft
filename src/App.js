...
var account = null;
var contract = null;
const ADDRESS = "0x1e5B949734C92c0204eeAE0DdFbF49BAf4CB6a9a";
  ...
  return (
    <div className="App">
      <div class="container">
        ...
        <div class="content">
            <h1>New 2022 NFT Collections</h1>
            <p>Mint from 1000 NFT AENQ now, and get early mint access to bla bla bla.</p>
            <a href="" class="mint-button">Mint an NFT</a>
        </div>
